                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="{{$lang->name}}" role="tabpanel">
                            <input type="hidden" name="item_id" id="item_id" value="{{Session::has('item_id')?Session::get('item_id'):$item->id}}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input class="form-control" style="width: 30px;" name="percentage_{{$i}}" type="text" value="{{Session::has('percentage_'.$i)?Session::get('percentage_'.$i):$detail->percentage*1}}" id="percentage_{{$i}}" required />
