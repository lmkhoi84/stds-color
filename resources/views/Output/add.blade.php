                                                ...
                                                @for($i = 1; $i <= $items; $i++) <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input class="form-control" style="width: 30px;" name="percentage_{{$i}}" type="text" value="{{Session::has('percentage_'.$i)?Session::get('percentage_'.$i):''}}" id="percentage_{{$i}}" required />
