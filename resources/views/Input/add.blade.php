                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control {{$errors->has('date')?'border-danger':''}}" name="date" id="date" type="text" value="{{Session::has('date')?Session::get('date'):''}}" placeholder="{{$translate->trans_page['date_holder']}}" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control {{$errors->has('staff')?'border-danger':''}}" name="staff" id="staff" type="text" value="{{Session::has('staff')?Session::get('staff'):''}}" placeholder="{{$translate->trans_page['staff_holder']}}" required />
                                <input type="hidden" name="staff_id" id="staff_id" value="{{Session::has('staff_id')?Session::get('staff_id'):''}}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control {{$errors->has('customer')?'border-danger':''}}" name="customer" id="customer" type="text" value="{{Session::has('customer')?Session::get('customer'):''}}" placeholder="{{$translate->trans_page['customer_holder']}}" required />
                                <input type="hidden" name="customer_id" id="customer_id" value="{{Session::has('customer_id')?Session::get('customer_id'):''}}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control {{$errors->has('number')?'border-danger':''}}" name="number" id="number" type="text" value="{{Session::has('number')?Session::get('number'):''}}" placeholder="{{$translate->trans_page['number_holder']}}" required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" name="note" id="note" type="text" value="{{Session::has('note')?Session::get('note'):''}}" />
                            </div>
                        </div>
                                    ...
                                    <table id="details" class="table table-hover table-striped">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            @for($i = 1; $i <= $items; $i++) <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" name="materialCode_{{$i}}" id="materialCode_{{$i}}" type="text" value="{{Session::has('materialCode_'.$i)?Session::get('materialCode_'.$i):''}}" required alt="{{$i}}" onkeyup="materialDetail_autocomplete(mList, this.alt)" />
                                                    <input type="hidden" name="materialId_{{$i}}" id="materialId_{{$i}}" value="{{Session::has('materialId_'.$i)?Session::get('materialId_'.$i):''}}">
                                                </td>
                                                <td><input class="form-control" style="width: 65px;" name="unit_{{$i}}" id="unit_{{$i}}" type="text" value="{{Session::has('unit_'.$i)?Session::get('unit_'.$i):''}}" disabled /></td>
                                                <td><input class="form-control" style="width: 100px;" name="type_{{$i}}" type="text" value="{{Session::has('type_'.$i)?Session::get('type_'.$i):''}}" id="type_{{$i}}" disabled /></td>
                                                <td>
                                                    <input class="form-control text-right" style="width: 100px;" name="quantity_{{$i}}" id="quantity_{{$i}}" alt="{{$i}}" type="text" value="{{Session::has('quantity_'.$i)?Session::get('quantity_'.$i):''}}" required onkeypress="check_number('quantity_{{$i}}')" onchange="calculate_qty(this.alt)" />
                                                </td>
                                                
                                                <td>
                                                    <input class="form-control text-right" style="width: 100px;" name="price_{{$i}}" id="price_{{$i}}" alt="{{$i}}" type="text" value="{{Session::has('price_'.$i)?Session::get('price_'.$i):''}}" onkeypress="check_number('price_{{$i}}')" onchange="calculate_qty(this.alt)"/>
                                                </td>
                                                <td>
                                                    <input class="form-control text-right" style="width: 100px;" name="total_{{$i}}" id="total_{{$i}}" type="text" value="{{Session::has('total_'.$i)?Session::get('total_'.$i):''}}" disabled />
                                                </td>
                                                </tr>
                                                    @php
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control text-right" style="padding-right: 35px;" name="amount" id="amount" type="text" value="{{Session::has('amount')?Session::get('amount'):''}}" disabled />
                            </div>
                        </div>
