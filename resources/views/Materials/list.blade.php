                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-center">
                                        <th>#</th>
                                        <th>{{$translate->trans_page['code']}}</th>
                                        <th>{{$translate->trans_page['name']}}</th>
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td>{{$item->crayola_code}} / {{$item->producer_code}}</td>
                                        <td>{{$item->crayola_name}} / {{$item->producer_name}}</td>
                                        <td class="text-center">{{$item->unit}}</td>
                                        <td class="text-center">{{$item->type == 1?$translate->trans_page['powder']:$translate->trans_page['liquid']}}</td>
