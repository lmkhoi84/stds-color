                        ...
                        @foreach ($langs as $lang)
                            ...
                            <div class="tab-pane fade show active" id="{{$lang->name}}" role="tabpanel">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control {{$errors->has('crayolaCode')?'border-danger':''}}" name="crayolaCode" type="text" value="{{Session::has('crayolaCode')?Session::get('crayolaCode'):''}}" id="crayolaCode" placeholder="{{$translate->trans_page['crayola_code_holder']}}" required />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control {{$errors->has('crayolaName_'.$lang->name)?'border-danger':''}}" name="crayolaName_{{$lang->name}}" type="text" value="{{Session::has('crayolaName_'.$lang->name)?Session::get('crayolaName_'.$lang->name):''}}" id="crayolaName_{{$lang->name}}" placeholder="{{$translate->trans_page['crayola_name_holder']}}" required />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control {{$errors->has('producerCode')?'border-danger':''}}" name="producerCode" type="text" value="{{Session::has('producerCode')?Session::get('producerCode'):''}}" id="producerCode" placeholder="{{$translate->trans_page['producer_code_holder']}}" required />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control {{$errors->has('producerName_'.$lang->name)?'border-danger':''}}" name="producerName_{{$lang->name}}" type="text" value="{{Session::has('producerName_'.$lang->name)?Session::get('producerName_'.$lang->name):''}}" id="producerName_{{$lang->name}}" placeholder="{{$translate->trans_page['producer_name_holder']}}" required />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                            <input type="radio" class="btn-check" name="type" id="type1" checked autocomplete="off" value="1" />
                                            <label class="btn btn-outline-primary" for="type1">{{$translate->trans_page['powder']}}</label>
                                            <input type="radio" class="btn-check" name="type" id="type2" autocomplete="off" value="2" />
                            ...
                            @endif
                            @php
                                Session::forget('materialName_'.$lang->name);
