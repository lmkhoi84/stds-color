                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="{{$lang->name}}" role="tabpanel">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="easyui-combotree form-control" name="parent_id" id="parent_id" data-options="url:'{{url('json_data/article-categories.json')}}',method:'get'" style="width:100%" value="{{Session::get('parent_id')?Session::get('parent_id'):$parent_id}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
