            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('address')?'border-danger':''}}" type="text" name="address" id="address" value="{{Session::has('address')?Session::get('address'):$item->address}}" placeholder="{{$translate->trans_page['address_holder']}}" required/>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('tax_code')?'border-danger':''}}" type="text" name="tax_code" id="tax_code" value="{{Session::has('tax_code')?Session::get('tax_code'):$item->tax_code}}" placeholder="{{$translate->trans_page['tax_code_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('contact_name')?'border-danger':''}}" type="text" name="contact_name" id="contact_name" value="{{Session::has('contact_name')?Session::get('contact_name'):$item->contact_name}}" placeholder="{{$translate->trans_page['contact_name_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('contact_phone')?'border-danger':''}}" type="text" name="contact_phone" id="contact_phone" value="{{Session::has('contact_phone')?Session::get('contact_phone'):$item->contact_phone}}" placeholder="{{$translate->trans_page['contact_phone_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('contact_email')?'border-danger':''}}" type="text" name="contact_email" id="contact_email" value="{{Session::has('contact_email')?Session::get('contact_email'):$item->contact_email}}" placeholder="{{$translate->trans_page['contact_email_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('consignee_name')?'border-danger':''}}" type="text" name="consignee_name" id="consignee_name" value="{{Session::has('consignee_name')?Session::get('consignee_name'):$item->consignee_name}}" placeholder="{{$translate->trans_page['consignee_name_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('consignee_phone')?'border-danger':''}}" type="text" name="consignee_phone" id="consignee_phone" value="{{Session::has('consignee_phone')?Session::get('consignee_phone'):$item->consignee_phone}}" placeholder="{{$translate->trans_page['consignee_phone_holder']}}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{$errors->has('delivery_address')?'border-danger':''}}" type="text" name="delivery_address" id="delivery_address" value="{{Session::has('delivery_address')?Session::get('delivery_address'):$item->delivery_address}}" placeholder="{{$translate->trans_page['delivery_address_holder']}}" />
                        </div>
                    </div>
...
<script>
    var list = {!! $cList !!};
    $('#name').keyup(function(){
        material_autocomplete('name',list);
    });
</script>
@endsection