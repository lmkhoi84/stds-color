                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="{{$lang->name}}" role="tabpanel">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control {{$errors->has('name_'.$lang->name)?'border-danger':''}}" name="name_{{$lang->name}}" type="text" value="{{old('name_'.$lang->name)?old('name_'.$lang->name):''}}" id="html5-search-input" placeholder="{{$translate->trans_page['name_holder']}}" required />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control {{$errors->has('code')?'border-danger':''}}" name="code" type="text" value="{{old('code')?old('code'):''}}" id="html5-search-input" placeholder="{{$translate->trans_page['code_holder']}}" required />
                                </div>
                            </div>
