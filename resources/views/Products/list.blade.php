                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th>{{$translate->trans_page['composition']}}</th>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{url($active_url).'/show/'.$item->id}}"><i class="bx bx-edit-alt me-1"></i> {{$translate->trans_page['show']}}</a>
