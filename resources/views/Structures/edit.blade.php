                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="{{$lang->name}}" role="tabpanel">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="easyui-combotree form-control" name="parent_id" id="parent_id" data-options="url:'{{url('json_data/structure.json')}}',method:'get'" style="width:100%" value="{{Session::get('parent_id')?Session::get('parent_id'):$item->parent_id}}">
                                </div>
                            </div>
                            @php Session::forget('parent_id') @endphp
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control {{$errors->has('strucName_'.$lang->name)?'border-danger':''}}" name="strucName_{{$lang->name}}" type="text" value="{{old('strucName_'.$lang->name)?old('strucName_'.$lang->name):$name[$lang->name]}}" id="html5-search-input" placeholder="{{$translate->trans_page['structure_name_holder']}}" required />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control {{$errors->has('icon')?'border-danger':''}}" name="icon" type="text" value="{{old('icon')?old('icon'):$item->icon}}" id="html5-url-input" placeholder="{{$translate->trans_page['menu_icon_holder']}}" />
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" name="page_type" id="page_type1" {{$item->page_type==1?'checked':''}} autocomplete="off" value="1" />
                                        <label class="btn btn-outline-primary" for="page_type1">{{$translate->trans_page['menu']}}</label>
                                        <input type="radio" class="btn-check" name="page_type" id="page_type2" {{$item->page_type==2?'checked':''}} autocomplete="off" value="2" />
                                        <label class="btn btn-outline-primary" for="page_type2">{{$translate->trans_page['category']}}</label>
                                        <input type="radio" class="btn-check" name="page_type" id="page_type3" {{$item->page_type==3?'checked':''}} autocomplete="off" value="3" />
